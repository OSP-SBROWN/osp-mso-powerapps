CREATE     PROCEDURE [ui].[HierMan2_GetAllVersions]
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT 
            ...
            HierarchyVersion_Status AS [Status],
            HierarchyVersion_CreatedBy AS [CreatedBy],
            HierarchyVersionCreatedDate AS [CreatedDate]
        FROM 
